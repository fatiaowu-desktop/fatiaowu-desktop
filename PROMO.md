...
标题：给 DeepSeek Harness 做了个原生 macOS 外壳，三套皮肤 + 毛玻璃 + 余额监控

正文：
给 DeepSeek Harness 写了个原生 macOS 桌面外壳「发条屋」——Swift + AppKit + WKWebView，整个 App 只有 1.6MB（不打包浏览器），打开即用。

亮点：
- 三套手搓皮肤：暗金·深夜 / 翡翠·晨光 / 猩红·熔岩，⌥⌘1/2/3 秒切
- 全界面毛玻璃（气泡、输入卡、侧栏、标题栏、权限弹窗）
- 无缝粒子动画：猩红熔岩粒子+烟尘+光晕呼吸，暗金工作区萤火虫星尘（循环零跳帧）
- 余额监控：实时显示 DeepSeek 余额和本次消费
- 表情面板、鲸鱼头像、完整会话统计

开源（MIT）：https://github.com/fatiaowu-desktop/fatiaowu-desktop
DSH 社区展示帖：https://github.com/deepseek-ai/deepseek-harness/discussions/2032

三套皮肤截图：https://github.com/fatiaowu-desktop/fatiaowu-desktop#%F0%9F%96%BC-%E4%B8%80%E8%A7%88

需要 macOS 14+ / Node 18+ / DeepSeek API Key。皮肤适配 DSH 0.1.0-rc.6。
